        ...
        <div class="mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-800 dark:text-gray-100">{{ estadoCuenta.user?.name || '-' }}</p>
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ estadoCuenta.user?.email || '-' }}</p>
                </div>
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Membresia</p>
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-800 dark:text-gray-100">{{ estadoCuenta.membresia.entidad.nombre }}</p>
                </div>
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Mes</p>
                    <p class="text-lg font-semibold text-gray-800 dark:text-gray-100">{{ formatearMes(estadoCuenta.mes_pagado) }}</p>
                </div>
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Importe</p>
                    <p class="text-lg font-semibold text-gray-800 dark:text-gray-100">${{ parseFloat(estadoCuenta.importe).toFixed(2) }}</p>
                </div>
            </div>
        </div>
        ...
        <form @submit.prevent="$emit('submit')">
                ...
                <div class="flex gap-4">
                    ...
                    <label class="flex items-center">
                        <input
                            ...
                            class="mr-2"
                        >
                        <span class="text-gray-700 dark:text-gray-300">Pagado</span>
                    </label>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <span v-if="estadoCuenta.comprobante" class="text-sm text-gray-600 dark:text-gray-400">
