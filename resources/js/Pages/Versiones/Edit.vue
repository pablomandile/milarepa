...
import VersionForm from '@/Components/Formularios/VersionForm.vue';
...
<template>
    <AppLayout title="Editar Versión">
        <template #header>
            <h1 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">Editar Versión</h1>
        </template>
        <div class="py-12">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                        <VersionForm 
                            :updating="true"
                            :form="form" 
                            @submit="form.put(route('versiones.update', version.id))" />
                    </div>
                </div>
            </div>
        </div>
