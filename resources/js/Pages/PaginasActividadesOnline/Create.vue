<script>
export default {
    name: 'PaginasActividadesOnlineCreate'
}
</script>
...
<template>
    <AppLayout>
        <template #header>
            <h1 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">Nueva Conf. Pagina Actividades Online</h1>
        </template>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-soft-indigo sm:rounded-lg">
                    ...
                    <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                        <PaginaActividadOnlineForm
                            ...
                            :form="form"
                            :imagen-preview-url="''"
                            @submit="form.post(route('paginas-actividades-online.store'))"
                        />
                    </div>
                </div>
            </div>
