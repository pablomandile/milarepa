...
const form = useForm({
    ...
    descripcion: props.email.descripcion,
    plantilla_archivo: props.email.plantilla_archivo,
});
...
<template>
    <AppLayout>
        <template #header>
            <h1 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">Editar Email</h1>
        </template>
        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-soft-indigo sm:rounded-lg">
                    ...
                    <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                        <form @submit.prevent="form.put(route('emails.update', props.email.id))" class="space-y-6">
                            <div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex gap-2">
                                    ...
                                    <button
                                        type="button"
                                        class="px-4 py-2 rounded bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-100 hover:bg-gray-300 dark:hover:bg-gray-600"
