...
const form = useForm({
    ...
    coordinador_ids: Array.isArray(props.clase.coordinadores)
        ? props.clase.coordinadores.map((coordinador) => coordinador.id)
        : (props.clase.coordinador_id ? [props.clase.coordinador_id] : []),
...
<template>
    <AppLayout title="Editar Clase">
        <template #header>
            <h1 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">Editar Clase</h1>
        </template>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-soft-indigo sm:rounded-lg">
                        <div class="p-6 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                            <div class="mb-6">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Edita la informacion de la clase seleccionada.</p>
                            </div>
