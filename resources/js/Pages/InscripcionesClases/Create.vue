<script>
export default {
    name: 'InscripcionesClasesCreate'
}
</script>
...
const submit = () => {
    form.post(route('inscripciones-clases.store'));
};
</script>
...
<template>
    <AppLayout>
        <template #header>
            <h1 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">Registro de Inscripción a Clase</h1>
        </template>
