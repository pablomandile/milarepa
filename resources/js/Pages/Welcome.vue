...
<template>
    ...
    <div class="relative flex flex-col justify-center items-center min-h-screen bg-dots-darker bg-center bg-indigo-100 dark:bg-dots-lighter dark:bg-indigo-900 selection:bg-red-500 selection:text-white">
