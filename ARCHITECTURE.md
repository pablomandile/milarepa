...
| ~~Upload sin renombrado seguro en `GridActividadesController::uploadComprobante`~~ | — | **Mitigado**: la subida pasa por `OptimizadorImagenService::procesar()` (nombre generado por Laravel) |
